        ...
        private void btnGuardar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    if (this.IsNuevo)
                    {
                        rptaDatosBasicos = fSistema_Academico_AreaAcademica.Guardar_DatosBasicos(this.TBAuto.Text, this.TBArea.Text, Convert.ToInt32(this.TBAño.Text), this.CBEstado.Text);
                    }
