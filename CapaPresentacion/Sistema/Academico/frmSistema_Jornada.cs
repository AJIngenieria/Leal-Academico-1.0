...
{
    public partial class frmSistemaAcademico_Jornada : Form
    {
        private bool IsNuevo = false;
        public frmSistemaAcademico_Jornada()
        {
            InitializeComponent();
        }

        private void frmSistemaAcademico_Jornada_Load(object sender, EventArgs e)
        {
        ...
        private void btnGuardar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                //Datos Basicos
                if (this.TBJornada.Text == string.Empty)
                {
                ...
                else
                {
                    if (this.IsNuevo)
                    {
                        rptaDatosBasicos = fSistema_Academico_Jornadas.Guardar_DatosBasicos(this.TBAuto.Text, this.TBJornada.Text, Convert.ToInt32(this.CBEstado.Text));
                    }
                    ...
                    if (rptaDatosBasicos.Equals("OK"))
                    {
                        if (this.IsNuevo)
                        {
                            this.MensajeOk("Jornada Registrada Exitosamente");
                        }
                    }
